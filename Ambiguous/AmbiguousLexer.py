...
def serializedATN():
    return [
        ...
        28,1,0,0,0,15,16,5,43,0,0,16,2,1,0,0,0,17,18,5,42,0,0,18,4,1,0,0,
        0,19,20,5,40,0,0,20,6,1,0,0,0,21,22,5,41,0,0,22,8,1,0,0,0,23,24,
        5,76,0,0,24,10,1,0,0,0,25,26,5,73,0,0,26,12,1,0,0,0,27,29,7,0,0,
        0,28,27,1,0,0,0,29,30,1,0,0,0,30,28,1,0,0,0,30,31,1,0,0,0,31,32,
        1,0,0,0,32,33,6,6,0,0,33,14,1,0,0,0,2,0,30,1,6,0,0
    ]

class AmbiguousLexer(Lexer):
